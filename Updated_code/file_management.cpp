...
int displayPauseMenu() {
    ...
    renderText(300, 200, "Game Paused");
    renderText(300, 250, "1. Resume Game");
    renderText(300, 300, "2. Start New Game");
    renderText(300, 350, "3. Exit Game");
    renderText(300, 400, "Press the number corresponding to your choice.");
